...
This demo provides an open movie recommendation API that has been built using Python and deployed on Heroku. 
...
## Use this API whilst building your website or app and recommend movies to your users accordingly.
